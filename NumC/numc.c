...
static PyObject *Matrix61c_add(Matrix61c* self, PyObject* args) {
    ...
    PyObject new;
    int i;
    PyArg_UnpackTuple(args, "args", 1, 1, &mat);
    if(!PyObject_TypeCheck(mat1, &Matrix61cType)){
        PyErr_SetString(PyExc_TypeError, "Invalid Type");
    }
    Matrix61c* mat2 = self;
    Matrix61c* mat2 = (Matrix61c*)mat;
    Matrix61c* result = Matrix61c*;
    if((PyTuple_GET_ITEM(mat1->shape, 0) != PyTuple_GET_ITEM(mat2->shape, 0))||(PyTuple_GET_ITEM(mat1->shape, 1) != PyTuple_GET_ITEM(mat2->shape, 1))){
        PyErr_SetString(PyExc_TypeError, "wrong dim");
    }
    Matrix61c_init(new, mat1->shape1, NULL);
    sub_matrix(new->mat, mat1->mat, mat2->mat);
    return new;
    }
...
static PyObject *Matrix61c_sub(Matrix61c* self, PyObject* args) {
    /* TODO: YOUR CODE HERE */
        ...
        Matrix61c_init(new, mat1->shape , NULL);
        sub_matrix(new->mat, mat1->mat, mat2->mat);
        return new;
    }
...
static PyObject *Matrix61c_multiply(Matrix61c* self, PyObject *args) {
    ...
    PyObject* shape = NULL;
    Matrix61c result;
    PyArg_UnpackTuple(args, "args", 1, 1, &mat2);
    if(!PyObject_TypeCheck(mat1, &Matrix61cType)){
        PyErr_SetString(PyExc_TypeError, "Invalid Type");
    }
    mat2 = (Matrix61c*)mat2;
    if((PyTuple_GET_ITEM(mat1->shape, 1) != PyTuple_GET_ITEM(mat2->shape, 0)){
        PyErr_SetString(PyExc_TypeError, "wrong dim");
    }
    shape = PyTuple_Pack(2, PyTuple_GET_ITEM(mat1->shape, 0), PyTuple_GET_ITEM(mat2->shape, 1));
    Matrix61c_init(result, shape , NULL);
    mul_matrix(result->mat, mat1->mat, mat2->mat);
    return result;
    }
...
static PyObject *Matrix61c_neg(Matrix61c* self) {
    /* TODO: YOUR CODE HERE */
        (Matrix61c*)mat1 = self;
        Matrix61c* result;
        PyObject* shape = (PyObject*) PyTuple_Pack(2,PyTuple_GET_ITEM((mat1->shape, 0), PyTuple_GET_ITEM(mat1->shape,1)));
        Matrix61c_init(result, shape , NULL);
        neg_matrix(result->mat, mat1->mat);
        return result;
}
...
static PyObject *Matrix61c_abs(Matrix61c *self) {
    /* TODO: YOUR CODE HERE */
         (Matrix61c*) mat1 = self;
         PyObject* shape = (PyObject*) PyTuple_Pack(2,PyTuple_GET_ITEM((mat1->shape, 0), PyTuple_GET_ITEM(mat1->shape,1)));
         Matrix61c* result = Matrix61c_init(new, shape, NULL);;
         abs_matrix(result->mat, mat1->mat);
         return result;
}
...
static PyObject *Matrix61c_pow(Matrix61c *self, PyObject *pow, PyObject *optional) {
    /* TODO: YOUR CODE HERE */
        ...
        PyObject* shape = NULL;
        Matrix61c* result;
        if((PyTuple_GET_ITEM(mat1->shape, 0) != PyTuple_GET_ITEM(mat2->shape, 1)){
            PyErr_SetString(PyExc_TypeError, "wrong dim");
        }
        shape = (PyObject*) PyTuple_Pack(2,PyTuple_GET_ITEM((mat1->shape, 0), PyTuple_GET_ITEM(mat1->shape,1)));
        if(!PyFloat_Check(pow)){
        PyErr_SetString(PyExc_TypeError, "pow is wrong");
        }
        Matrix61c_init(result, shape , NULL);
        pw_matrix(result->mat, mat1->mat,(int) PyFloat_AS_DOUBLE(pow));
        return result;
}
...
static PyObject *Matrix61c_set_value(Matrix61c *self, PyObject* args) {
            int cols_= ((self->mat)->cols);
            int rows_= ((self->mat)->rows);
            PyObject* result = NULL;
            PyObject* getcol;
            PyObject* getrow;
            PyObject* getval;
            PyArg_UnpackTuple(args, "args", 3, 3, &getrow, &getcol, &getval);
            getcol = (int)getcol;
            getrow = (int)getrow;
            getval = (int)getval;
            set(self->mat,getrow,getcol,getval)
            return result;
}
...
static PyObject *Matrix61c_get_value(Matrix61c *self, PyObject* args) {
    /* TODO: YOUR CODE HERE */
            ...
            PyObject* getrow;
            PyObject* getval;
            PyArg_UnpackTuple(args, "args", 2, 2, &getrow, &getcol);
            val = get(self->mat,getrow,getcol);
...
static PyMethodDef Matrix61c_methods[] = {
    /* TODO: YOUR CODE HERE */
            {"set",(PyCFunction)Matrix61c_set_value, METH_VARARGS, "set val to (row, col) in mat"},
    {"get", (PyCFunction)&Matrix61c_get_value, METH_VARARGS, "get at (row, col) in mat"},
    {NULL, NULL, 0, NULL}
};
